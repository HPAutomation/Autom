...
public class JenkinsTest {
	...
	//	System.out.println("First Job:"+jobList.get(0));
		...
		//copyJob("http://admin:admin@20.1.3.88:8080", "AA_TEST_JOB2", "HPIAutomation");
		createJob("http://admin:admin@20.1.3.88:8080", "AA_TEST_JOB3", "<project><builders/><publishers/><buildWrappers/></project>");
...
*/	}
	...
	public static List<String> listJobs(String url) {
		url="http://admin:admin@20.1.3.88:8080";
...
//		System.out.println("Response copyJob:::::"+jsonResponse);
	...
	public static String createJob(String url, String newJobName, String configXML){
		Client client = Client.create();
		client.addFilter(new com.sun.jersey.api.client.filter.HTTPBasicAuthFilter("admin", "admin"));
		WebResource webResource = client.resource("-H '9f21a302502899f45620742c827415c0' "+ url+"/createItem?name="+newJobName);
